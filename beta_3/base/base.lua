...
function base:init(game,map_name,eleccion,ip,puerto,cantidad,nombre,cantidad_enemigos)
	...
	game.entidades=entidades(cam,vector,signal,eleccion,map,ip,puerto,cantidad,nombre,map_name,cantidad_enemigos)
