...
function img_personajes_cliente:tipos(tipo,obj_data,spritesheet,spritesheet_escudo)
	if tipo=="aegis" then
		self:aegis(obj_data,spritesheet,spritesheet_escudo)
	elseif tipo=="solange" then
		self:solange(obj_data,spritesheet,spritesheet_escudo)
	elseif tipo=="xeon" then
		self:xeon(obj_data,spritesheet,spritesheet_escudo)
	elseif tipo=="radian" then
		self:radian(obj_data,spritesheet,spritesheet_escudo)
	end
end
